        ...
        <b-list-group>
            <b-list-group-item class="d-flex justify-content-between" variant="secondary">
                <div class="d-flex align-items-center">
                    ...
                    <b class="ml-5">Item availability</b>
                    <b class="ml-5">Item price</b>
                </div>
                <div class="d-flex flex-row-reverse align-content-center">
                    <b-button class="mr-2" @click="applyChanges" variant="primary">Apply changes</b-button>
                    <b-button class="mr-2" @click="addNewItem" variant="success">Add item</b-button>
                </div>
            </b-list-group-item>
            <b-list-group-item class="d-flex justify-content-between" v-for="(item, index) in shopItems">
                <div class="d-flex align-items-center">
                    <b class="ml-2">{{item.name}}</b>
                    <b-form-select class="ml-5" v-model="item.availability" :options="availabilityOptions"></b-form-select>
                    <b-form-input
                            class="ml-5"
                            v-model="item.price"
                            type="number"
